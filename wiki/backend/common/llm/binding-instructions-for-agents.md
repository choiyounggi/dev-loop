...
related: [backend-common-api-design-agent-tool-granularity, backend-common-llm-progressive-disclosure-artifacts, qa-document-verification-rationale-prose-after-a-config-value-change, qa-deliverables-obligation-row-without-a-named-actor]
---
