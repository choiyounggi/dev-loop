...
|---------|------------------|
| [common](#common-language-agnostic) (below) | The concern is language-agnostic: API contracts, idempotency, JWT issuance, outbound calls, consuming an external/LLM API's response contract, defaults naming repo-external resources, caching, jobs, transactions in app code, shared state/pools, exception structure |
