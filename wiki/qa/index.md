...
| [completion-claims](process/completion-claims.md) | About to report work as done, fixed, or passing — to a human, a coordinator, a PR, or a commit message; about to write "should work" or "tests pass" without a fresh run; deciding what evidence a completion claim requires; relaying a subagent's success report; relaying a delegated auditor's claim that it mutated and restored your uncommitted filesciting an existing green test as proof that a stage is healthy |
