...
related: [databases-transactions-isolation-level-selection, databases-transactions-multi-row-reorder-on-a-shared-resource, backend-python-language-dict-subclass-attribute-loss-on-copy]
---
