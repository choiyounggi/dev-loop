...
related: [qa-process-evaluating-review-feedback, testing-quality-checks-that-cannot-pass, infrastructure-agent-orchestration-control-signals-vs-primary-artifacts]
---
...
4. Keep the repo's test convention intact: a redundant bare `assert` or
