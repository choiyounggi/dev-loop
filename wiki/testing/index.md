...
| [migration-call-site-survey](quality/migration-call-site-survey.md) | Changing a function/constructor signature or the shape of a value it takes and updating every caller; about to report a call-site count from a text search ("13 sites, 7 updated"); reviewing a migration PR that claims full coverage; the suite broke in one file after a migration you believed complete; deciding whether test helpers/factories that build the old shape are in scope |
