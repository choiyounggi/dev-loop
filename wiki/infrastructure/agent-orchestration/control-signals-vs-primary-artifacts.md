...
related: [infrastructure-agent-orchestration-shared-run-state, infrastructure-agent-orchestration-pane-delivery-confirmation, infrastructure-agent-orchestration-session-completion-gates, platforms-shells-command-text-inspected-before-execution, platforms-tools-harness-mediated-tool-results, debugging-methodology-hypothesis-testing, infrastructure-agent-orchestration-unattended-worker-questions, debugging-methodology-probe-path-vs-operation-path, qa-process-completion-claims, infrastructure-agent-orchestration-autonomous-decision-rulings, platforms-tools-deny-rules-under-bypassed-permissions]
---
